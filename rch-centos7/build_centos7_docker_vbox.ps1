...
$Env:BOX_DESCRIPTION = "A CentOS7 box image"
...
& .\NetworksExecuteVboxPackerBuild.ps1 `
  -PackerBuilder "RCH_CentOS7_DOCKER_VIRTUALBOX" `
  -PackerTemplate "rch-centos7-docker-packer.json" `
  -VarsFiles "stack_vars/rch-centos7-docker-vars.json"
