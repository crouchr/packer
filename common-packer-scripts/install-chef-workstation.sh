...
sudo curl -o /tmp/chef-workstation-24.2.1058-1.el7.x86_64.rpm http://ansible-packer.ermin.lan/centos7-packages/chef-workstation-24.2.1058-1.el7.x86_64.rpm
