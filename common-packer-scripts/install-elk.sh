...
# ELK
wget -O /tmp/elasticsearch-7.9.2-x86_64.rpm http://192.168.1.4/centos-packages/elasticsearch-7.9.2-x86_64.rpm
wget -O /tmp/logstash-oss-7.9.2.rpm http://192.168.1.4/centos-packages/logstash-oss-7.9.2.rpm
wget -O /tmp/kibana-oss-7.9.2-x86_64.rpm http://192.168.1.4/centos-packages/kibana-oss-7.9.2-x86_64.rpm
